...
const updateRestaurantById = async (id: number, body: object): Promise<ApiResponse<null>> => {
  return HttpRequest.networkRequest({ url: baseUrl + 'restaurant/' + id, method: HttpRequest.HttpMethod.PATCH, queryParams: { body: body } })
}
